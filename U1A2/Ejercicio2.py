...
When called, the function will print to the screen a message in the form: “The cube of number [num] is [cube]”.
Where [cube] should be replaced with the cube of the number received as input.
Write a function to be running in parallel, call it print_square. The function should receive as input a number [num]. 
...
def main():
    # crear la pool con los 2 trabajadores
    with multiprocessing.Pool(processes=2) as pool:
        # List of numbers for which we want to calculate square and cube
        numbers = [2, 3, 4, 5, 6]

        # Ejecuta las funciones print_square y print_cube  en paralelo usando la pool
